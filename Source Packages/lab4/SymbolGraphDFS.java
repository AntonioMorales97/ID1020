 ...
 * graph using a modified depth-first search algorithm. See {@link DepthFirstShortestPaths}.
 * 
 * @author Antonio
 *
 */
public class SymbolGraphDFS {
     ...
     */
    public SymbolGraphDFS(String filename, String delimiter) {
    ...
    public static void main(String[] args) {
        ...
        SymbolGraphDFS symbolGraph = new SymbolGraphDFS(filename, delimiter);
        Graph graph = symbolGraph.graph();
        DepthFirstShortestPaths dfs = new DepthFirstShortestPaths(graph, symbolGraph.indexOf(sourceVertex));

        if (!dfs.hasPathTo(symbolGraph.indexOf(destinationVertex)))
        ...
        for (int i : dfs.pathTo(symbolGraph.indexOf(destinationVertex)))
        ...
        System.out.println("The shortest path between the vertices " + sourceVertex + " and " + destinationVertex
                + " is " + dfs.distTo(symbolGraph.indexOf(destinationVertex))
